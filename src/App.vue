<template>
  <div id="app">
    <Header/>
    <div class="container">
      <MapFilter @filterOut="mapFilter" @addrSelectOut="mapViewAddr" @quarriesData="mapViewQuarries"  @plantsData="mapViewPlants" @drsuSelectOut="mapViewDrsu" />
...
export default {
  ...
  methods: {
    ...
    mapViewDrsu: function (data) {
      this.$refs.Map.viewDrsu(data)
    },
